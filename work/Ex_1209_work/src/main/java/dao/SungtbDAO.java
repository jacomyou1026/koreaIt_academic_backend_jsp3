...
public List<SungtbVo> selectList() {
	List<SungtbVo> list = new ArrayList<SungtbVo>();
	...
	try {
		...
		while (rs.next()) {
			...
			vo.setSub_total(rs.getInt("total"));
			vo.setSug_avg(rs.getDouble("avg"));
